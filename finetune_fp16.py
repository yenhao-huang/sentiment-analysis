...
if __name__ == "__main__":
    ...
    data_utils.data_preprocess = utils.measure_time(data_utils.data_preprocess)
    ...
    train_agent = model_utils.set_train_agent(
        args.model, 
        train_dataset, 
        eval_dataset, 
        tokenizer, 
    ...
    train_agent.train = utils.measure_time(train_agent.train)
    train_agent.train()